    ...
    <div style={{ maxWidth: '900px', margin: '0 auto', padding: '3rem 1.5rem' }}>
      ...
      <div className="card" style={{
        ...
        <h2 style={{
          ...
          <Video size={18} color="var(--color-info)" /> How Teleconsult Links Work
        </h2>
        ...
        <div style={{
          ...
          <p style={{ margin: '0 0 0.5rem' }}>
            ✅ A <strong>unique Jitsi Meet link</strong> is automatically generated for each Teleconsult appointment.
          </p>
          <p style={{ margin: '0 0 0.5rem' }}>
            ✅ The link is stored in the appointment record and displayed in the booking confirmation.
          </p>
          <p style={{ margin: '0' }}>
            ✅ Patients can access their link through the <strong>"My Appointments"</strong> tracker using their booking reference.
          </p>
        </div>
      </div>
      ...
      <div style={{
        ...
        <div>
          <strong style={{ color: 'var(--color-text-main)' }}>Automated Link Generation:</strong>{' '}
          <span style={{ color: 'var(--color-text-sub)' }}>
            Teleconsult links are automatically generated for all Teleconsult appointments — both 
            from public bookings and internal scheduling. Links follow the format 
            <code> clinixehr-{'{appointmentId}'}</code> and are immediately available after booking.
          </span>
        </div>
      </div>
    </div>
